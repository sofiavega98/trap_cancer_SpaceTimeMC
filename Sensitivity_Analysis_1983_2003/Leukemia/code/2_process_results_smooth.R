...
data_path="/n/holylfs05/LABS/nethery_lab/Users/svega/trap_cancer_mc/data/Leukemia_1983_2003_0-9.RData" # path to application data
adj_mat_path="/n/holylfs05/LABS/nethery_lab/Users/svega/trap_cancer_mc/data/leukemia_adj_mat_1983_2003_0-9.RData" # path to adjacency matrix
dir_out="/n/holylfs05/LABS/nethery_lab/Users/svega/trap_cancer_mc/Sensitivity_Analysis_1983_2003/Leukemia/Results/" # directory output path for results
...
# shrinkage model
load(paste0(dir_out,"fit_shrink_trt",trt_year,"_k3_smooth.RData"))
fit_shrink<- fit
...
save(rhat_vec, file=paste0(dir_out,"rhat_vec_trt",trt_year,"_smooth.RData"))
...
save(res, file=paste0(dir_out,"processed_res_trt",trt_year,"_smooth.RData"))
