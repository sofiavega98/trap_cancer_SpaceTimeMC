...
data_path="~/cl_quasi_exp/data/Leukemia_1983_2003_0-9.RData" # path to application data
adj_mat_path="~/cl_quasi_exp/data/leukemia_adj_mat_1983_2003_0-9.RData" # path to adjacency matrix
dir_out="~/cl_quasi_exp/Sensitivity_Analysis_1983_2003/Leukemia/Results/" # directory output path for results
...
#Mu_trt_shrink <- NA
#fit_shrink <- NA
load(paste0(dir_out,"fit_shrink_trt",trt_year,"_k3.RData"))
fit_shrink<- fit
...
save(rhat_vec, file=paste0(dir_out,"rhat_vec_trt",trt_year,".RData"))
...
save(res, file=paste0(dir_out,"processed_res_trt",trt_year,".RData"))
