...
# load functions
source('/n/holylfs05/LABS/nethery_lab/Users/svega/trap_cancer_mc/freq_post_processing_functions.R')
...
dir_out <- "/n/holylfs05/LABS/nethery_lab/Users/svega/trap_cancer_mc/Simulations/Main/Processed_Results"

#####################
## 1. Load results ##
#####################

load(paste0("/n/holylfs05/LABS/nethery_lab/Users/svega/trap_cancer_mc/Simulations/Main/Results/sim_Rare_freq.RData"))
results_Rare <- results
load(paste0("/n/holylfs05/LABS/nethery_lab/Users/svega/trap_cancer_mc/Simulations/Main/Results/sim_nonRare_freq.RData"))
results_nonRare <- results

load(paste0("/n/holylfs05/LABS/nethery_lab/Users/svega/trap_cancer_mc/Simulations/Main/Results/sim_Rare_freq_smooth.RData"))
results_Rare_smooth <- results
load(paste0("/n/holylfs05/LABS/nethery_lab/Users/svega/trap_cancer_mc/Simulations/Main/Results/sim_nonRare_freq_smooth.RData"))
