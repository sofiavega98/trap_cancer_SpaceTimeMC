...
dir_in <- "/n/holylfs05/LABS/nethery_lab/Users/svega/trap_cancer_mc/Simulations/Main/Processed_Results/"
...
load(paste0(dir_in,"results_Rare_freq.Rdata"))
results_Rare_freq <- df
load(paste0(dir_in,"results_nonRare_freq.Rdata"))
results_nonRare_freq <- df
load(paste0(dir_in,"results_Rare_smooth_freq.Rdata"))
results_Rare_freq_smooth <- df
load(paste0(dir_in,"results_nonRare_smooth_freq.Rdata"))
