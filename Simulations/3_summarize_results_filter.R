...
# load functions
source('/n/holylfs05/LABS/nethery_lab/Users/svega/trap_cancer_mc/functions/post_procesing_functions.R')
...
########################################
## 4. Filter out MCMC samples with -1 ##
########################################
Y_pred_ori_1 <- filtering(Y_pred_ori_1)
Y_pred_space_1 <- filtering(Y_pred_space_1)
Y_pred_spacetime_ICAR_1 <- filtering(Y_pred_spacetime_ICAR_1)
Y_pred_spacetime_AR_1 <- filtering(Y_pred_spacetime_AR_1)
Y_pred_lasso_1 <- filtering(Y_pred_lasso_1)
Y_pred_space_comb_time_shrink_1 <- filtering(Y_pred_space_comb_time_shrink_1)

Y_pred_ori_3 <- filtering(Y_pred_ori_3)
Y_pred_space_3 <- filtering(Y_pred_space_3)
Y_pred_spacetime_ICAR_3 <- filtering(Y_pred_spacetime_ICAR_3)
Y_pred_spacetime_AR_3 <- filtering(Y_pred_spacetime_AR_3)
Y_pred_lasso_3 <- filtering(Y_pred_lasso_3)
Y_pred_space_comb_time_shrink_3 <- filtering(Y_pred_space_comb_time_shrink_3)

Y_pred_ori_7 <- filtering(Y_pred_ori_7)
Y_pred_space_7 <- filtering(Y_pred_space_7)
Y_pred_spacetime_ICAR_7 <- filtering(Y_pred_spacetime_ICAR_7)
Y_pred_spacetime_AR_7 <- filtering(Y_pred_spacetime_AR_7)
Y_pred_lasso_7 <- filtering(Y_pred_lasso_7)
Y_pred_space_comb_time_shrink_7 <- filtering(Y_pred_space_comb_time_shrink_7)
  
################################################################
## 5. Get Absolute Percent Bias of the Counterfactual vectors ##
################################################################
...
#Mu_trt_ori_1[[84]] <- matrix(0, nrow=1000,ncol=90)
...
# IQR
IQR_Y0_ori_1 <- medianAbsPercBiasY0_year(Mu_trt_ori_1,Y0_matrix_1,ind)$IQR
IQR_Y0_space_1 <- medianAbsPercBiasY0_year(Mu_trt_space_1,Y0_matrix_1,ind)$IQR
IQR_Y0_ICAR_1 <- medianAbsPercBiasY0_year(Mu_trt_spacetime_ICAR_1,Y0_matrix_1,ind)$IQR
IQR_Y0_AR_1 <- medianAbsPercBiasY0_year(Mu_trt_spacetime_AR_1,Y0_matrix_1,ind)$IQR
IQR_Y0_lasso_1 <- medianAbsPercBiasY0_year(Mu_trt_lasso_1,Y0_matrix_1,ind)$IQR

IQR_Y0_ori_3 <- medianAbsPercBiasY0_year(Mu_trt_ori_3,Y0_matrix_3,ind)$IQR
IQR_Y0_space_3 <- medianAbsPercBiasY0_year(Mu_trt_space_3,Y0_matrix_3,ind)$IQR
IQR_Y0_ICAR_3 <- medianAbsPercBiasY0_year(Mu_trt_spacetime_ICAR_3,Y0_matrix_3,ind)$IQR
IQR_Y0_AR_3 <- medianAbsPercBiasY0_year(Mu_trt_spacetime_AR_3,Y0_matrix_3,ind)$IQR
IQR_Y0_lasso_3 <- medianAbsPercBiasY0_year(Mu_trt_lasso_3,Y0_matrix_3,ind)$IQR

IQR_Y0_ori_7 <- medianAbsPercBiasY0_year(Mu_trt_ori_7,Y0_matrix_7,ind)$IQR
IQR_Y0_space_7 <- medianAbsPercBiasY0_year(Mu_trt_space_7,Y0_matrix_7,ind)$IQR
IQR_Y0_ICAR_7 <- medianAbsPercBiasY0_year(Mu_trt_spacetime_ICAR_7,Y0_matrix_7,ind)$IQR
IQR_Y0_AR_7 <- medianAbsPercBiasY0_year(Mu_trt_spacetime_AR_7,Y0_matrix_7,ind)$IQR
IQR_Y0_lasso_7 <- medianAbsPercBiasY0_year(Mu_trt_lasso_7,Y0_matrix_7,ind)$IQR
IQR_Y0_shrink_7 <- medianAbsPercBiasY0_year(Mu_trt_space_comb_time_shrink_7,Y0_matrix_7,ind)$IQR

# IQR
IQR_ATT_ori_1 <- medianAbsPercBiasATT_year(Mu_trt_ori_1,Y0_matrix_1,Y1_matrix_1,true_trt_effect_1,ind)$IQR
IQR_ATT_space_1 <- medianAbsPercBiasATT_year(Mu_trt_space_1,Y0_matrix_1,Y1_matrix_1,true_trt_effect_1,ind)$IQR
IQR_ATT_ICAR_1 <- medianAbsPercBiasATT_year(Mu_trt_spacetime_ICAR_1,Y0_matrix_1,Y1_matrix_1,true_trt_effect_1,ind)$IQR
IQR_ATT_AR_1 <- medianAbsPercBiasATT_year(Mu_trt_spacetime_AR_1,Y0_matrix_1,Y1_matrix_1,true_trt_effect_1,ind)$IQR
IQR_ATT_lasso_1 <- medianAbsPercBiasATT_year(Mu_trt_lasso_1,Y0_matrix_1,Y1_matrix_1,true_trt_effect_1,ind)$IQR

IQR_ATT_ori_3 <- medianAbsPercBiasATT_year(Mu_trt_ori_3,Y0_matrix_3,Y1_matrix_3,true_trt_effect_3,ind)$IQR
IQR_ATT_space_3 <- medianAbsPercBiasATT_year(Mu_trt_space_3,Y0_matrix_3,Y1_matrix_3,true_trt_effect_3,ind)$IQR
IQR_ATT_ICAR_3 <- medianAbsPercBiasATT_year(Mu_trt_spacetime_ICAR_3,Y0_matrix_3,Y1_matrix_3,true_trt_effect_3,ind)$IQR
IQR_ATT_AR_3 <- medianAbsPercBiasATT_year(Mu_trt_spacetime_AR_3,Y0_matrix_3,Y1_matrix_3,true_trt_effect_3,ind)$IQR
IQR_ATT_lasso_3 <- medianAbsPercBiasATT_year(Mu_trt_lasso_3,Y0_matrix_3,Y1_matrix_3,true_trt_effect_3,ind)$IQR

IQR_ATT_ori_7 <- medianAbsPercBiasATT_year(Mu_trt_ori_7,Y0_matrix_7,Y1_matrix_7,true_trt_effect_7,ind)$IQR
IQR_ATT_space_7 <- medianAbsPercBiasATT_year(Mu_trt_space_7,Y0_matrix_7,Y1_matrix_7,true_trt_effect_7,ind)$IQR
IQR_ATT_ICAR_7 <- medianAbsPercBiasATT_year(Mu_trt_spacetime_ICAR_7,Y0_matrix_7,Y1_matrix_7,true_trt_effect_7,ind)$IQR
IQR_ATT_AR_7 <- medianAbsPercBiasATT_year(Mu_trt_spacetime_AR_7,Y0_matrix_7,Y1_matrix_7,true_trt_effect_7,ind)$IQR
IQR_ATT_lasso_7 <- medianAbsPercBiasATT_year(Mu_trt_lasso_7,Y0_matrix_7,Y1_matrix_7,true_trt_effect_7,ind)$IQR
IQR_ATT_shrink_7 <- medianAbsPercBiasATT_year(Mu_trt_space_comb_time_shrink_7,Y0_matrix_7,Y1_matrix_7,true_trt_effect_7,ind)$IQR
...
IQR_absPercBias_Y0 <- round(c(IQR_Y0_ori_1,IQR_Y0_space_1,IQR_Y0_ICAR_1,IQR_Y0_AR_1,IQR_Y0_lasso_1,
                             IQR_Y0_ori_3,IQR_Y0_space_3,IQR_Y0_ICAR_3,IQR_Y0_AR_3,IQR_Y0_lasso_3,
                             IQR_Y0_ori_7,IQR_Y0_space_7,IQR_Y0_ICAR_7,IQR_Y0_AR_7,IQR_Y0_lasso_7,IQR_Y0_shrink_7),2)
...
IQR_absPercBias_ATT <- round(c(IQR_ATT_ori_1,IQR_ATT_space_1,IQR_ATT_ICAR_1,IQR_ATT_AR_1,IQR_ATT_lasso_1,
                              IQR_ATT_ori_3,IQR_ATT_space_3,IQR_ATT_ICAR_3,IQR_ATT_AR_3,IQR_ATT_lasso_3,
                              IQR_ATT_ori_7,IQR_ATT_space_7,IQR_ATT_ICAR_7,IQR_ATT_AR_7,IQR_ATT_lasso_7,IQR_ATT_shrink_7),2)
...
df <- cbind(Model,k,absPercBias_Y0,IQR_absPercBias_Y0,LB_absPercBias_Y0,UB_absPercBias_Y0,absPercBias_ATT,IQR_absPercBias_ATT,LB_absPercBias_ATT,UB_absPercBias_ATT)
...
# IQR
IQR_Y0_ori_1 <- medianAbsPercBiasY0_year(Y_pred_ori_1,Y0_matrix_1,ind)$IQR
IQR_Y0_space_1 <- medianAbsPercBiasY0_year(Y_pred_space_1,Y0_matrix_1,ind)$IQR
IQR_Y0_ICAR_1 <- medianAbsPercBiasY0_year(Y_pred_spacetime_ICAR_1,Y0_matrix_1,ind)$IQR
IQR_Y0_AR_1 <- medianAbsPercBiasY0_year(Y_pred_spacetime_AR_1,Y0_matrix_1,ind)$IQR
IQR_Y0_lasso_1 <- medianAbsPercBiasY0_year(Y_pred_lasso_1,Y0_matrix_1,ind)$IQR

IQR_Y0_ori_3 <- medianAbsPercBiasY0_year(Y_pred_ori_3,Y0_matrix_3,ind)$IQR
IQR_Y0_space_3 <- medianAbsPercBiasY0_year(Y_pred_space_3,Y0_matrix_3,ind)$IQR
IQR_Y0_ICAR_3 <- medianAbsPercBiasY0_year(Y_pred_spacetime_ICAR_3,Y0_matrix_3,ind)$IQR
IQR_Y0_AR_3 <- medianAbsPercBiasY0_year(Y_pred_spacetime_AR_3,Y0_matrix_3,ind)$IQR
IQR_Y0_lasso_3 <- medianAbsPercBiasY0_year(Y_pred_lasso_3,Y0_matrix_3,ind)$IQR

IQR_Y0_ori_7 <- medianAbsPercBiasY0_year(Y_pred_ori_7,Y0_matrix_7,ind)$IQR
IQR_Y0_space_7 <- medianAbsPercBiasY0_year(Y_pred_space_7,Y0_matrix_7,ind)$IQR
IQR_Y0_ICAR_7 <- medianAbsPercBiasY0_year(Y_pred_spacetime_ICAR_7,Y0_matrix_7,ind)$IQR
IQR_Y0_AR_7 <- medianAbsPercBiasY0_year(Y_pred_spacetime_AR_7,Y0_matrix_7,ind)$IQR
IQR_Y0_lasso_7 <- medianAbsPercBiasY0_year(Y_pred_lasso_7,Y0_matrix_7,ind)$IQR
IQR_Y0_shrink_7 <- medianAbsPercBiasY0_year(Y_pred_space_comb_time_shrink_7,Y0_matrix_7,ind)$IQR

# IQR
IQR_ATT_ori_1 <- medianAbsPercBiasATT_year(Y_pred_ori_1,Y0_matrix_1,Y1_matrix_1,true_trt_effect_1,ind)$IQR
IQR_ATT_space_1 <- medianAbsPercBiasATT_year(Y_pred_space_1,Y0_matrix_1,Y1_matrix_1,true_trt_effect_1,ind)$IQR
IQR_ATT_ICAR_1 <- medianAbsPercBiasATT_year(Y_pred_spacetime_ICAR_1,Y0_matrix_1,Y1_matrix_1,true_trt_effect_1,ind)$IQR
IQR_ATT_AR_1 <- medianAbsPercBiasATT_year(Y_pred_spacetime_AR_1,Y0_matrix_1,Y1_matrix_1,true_trt_effect_1,ind)$IQR
IQR_ATT_lasso_1 <- medianAbsPercBiasATT_year(Y_pred_lasso_1,Y0_matrix_1,Y1_matrix_1,true_trt_effect_1,ind)$IQR

IQR_ATT_ori_3 <- medianAbsPercBiasATT_year(Y_pred_ori_3,Y0_matrix_3,Y1_matrix_3,true_trt_effect_3,ind)$IQR
IQR_ATT_space_3 <- medianAbsPercBiasATT_year(Y_pred_space_3,Y0_matrix_3,Y1_matrix_3,true_trt_effect_3,ind)$IQR
IQR_ATT_ICAR_3 <- medianAbsPercBiasATT_year(Y_pred_spacetime_ICAR_3,Y0_matrix_3,Y1_matrix_3,true_trt_effect_3,ind)$IQR
IQR_ATT_AR_3 <- medianAbsPercBiasATT_year(Y_pred_spacetime_AR_3,Y0_matrix_3,Y1_matrix_3,true_trt_effect_3,ind)$IQR
IQR_ATT_lasso_3 <- medianAbsPercBiasATT_year(Y_pred_lasso_3,Y0_matrix_3,Y1_matrix_3,true_trt_effect_3,ind)$IQR

IQR_ATT_ori_7 <- medianAbsPercBiasATT_year(Y_pred_ori_7,Y0_matrix_7,Y1_matrix_7,true_trt_effect_7,ind)$IQR
IQR_ATT_space_7 <- medianAbsPercBiasATT_year(Y_pred_space_7,Y0_matrix_7,Y1_matrix_7,true_trt_effect_7,ind)$IQR
IQR_ATT_ICAR_7 <- medianAbsPercBiasATT_year(Y_pred_spacetime_ICAR_7,Y0_matrix_7,Y1_matrix_7,true_trt_effect_7,ind)$IQR
IQR_ATT_AR_7 <- medianAbsPercBiasATT_year(Y_pred_spacetime_AR_7,Y0_matrix_7,Y1_matrix_7,true_trt_effect_7,ind)$IQR
IQR_ATT_lasso_7 <- medianAbsPercBiasATT_year(Y_pred_lasso_7,Y0_matrix_7,Y1_matrix_7,true_trt_effect_7,ind)$IQR
IQR_ATT_shrink_7 <- medianAbsPercBiasATT_year(Y_pred_space_comb_time_shrink_7,Y0_matrix_7,Y1_matrix_7,true_trt_effect_7,ind)$IQR
