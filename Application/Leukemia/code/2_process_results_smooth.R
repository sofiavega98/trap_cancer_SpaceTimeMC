...
# shrinkage model
load(paste0(dir_out,"fit_shrink_trt",trt_year,"_k3_smooth_v2.RData"))
fit_shrink<- fit
...
##################################################
## Run Application on MC through gsynth and SVT ##
##################################################
