...
# Load data
load("~/cl_quasi_exp/Application/Lymphoma/Manuscript/ATT_table1995_Smooth.RData")
df <- table

load("~/cl_quasi_exp/Application/Lymphoma/Manuscript/ATT_table1995_Smooth_SensAnalysis.RData")
...
save_kable(table, file =  "~/cl_quasi_exp/Application/Lymphoma/Manuscript/ATT_trt1995_smooth_combined.tex",float = FALSE)
