...
# Load data
load("/n/holylfs05/LABS/nethery_lab/Users/svega/trap_cancer_mc/Application/Lymphoma/Manuscript/ATT_table1995_Smooth.RData")
df <- table

load("/n/holylfs05/LABS/nethery_lab/Users/svega/trap_cancer_mc/Application/Lymphoma/Manuscript/ATT_table1995_Smooth_SensAnalysis.RData")
...
save_kable(table, file =  "/n/holylfs05/LABS/nethery_lab/Users/svega/trap_cancer_mc/Application/Lymphoma/Manuscript/ATT_trt1995_smooth_combined.tex",float = FALSE)
